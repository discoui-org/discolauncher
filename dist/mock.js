import"./chunks/script-DlmsXyW5.js";function e(){if(document.body.classList.add(`mock-pointer`),document.querySelector(`div#m_pointer_0000HELLYEAH`))return document.querySelector(`div#m_pointer_0000HELLYEAH`);let e=document.createElement(`div`);return e.id=`m_pointer_0000HELLYEAH`,e.style.cssText=`
        position: fixed;
