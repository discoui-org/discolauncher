...
public class DiscoWebView extends WebView {
    ...
    public Bitmap getAppIcon(PackageManager mPackageManager, String packageNameWithIntent) {
        ...
        try {
            ...
            Log.d("discolauncher", "getAppIcon: OLMADI " + packageName);
    ...
    public DiscoWebView(Context context, AttributeSet attrs) {
        super(context, attrs);
        m_context = context;
    }

    public DiscoWebView(Context context, AttributeSet attrs, int defStyleAttr) {
