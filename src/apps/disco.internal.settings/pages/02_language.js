...
function updateLocaleInfo() {
    try {
        document.querySelector("#home-tab > div:nth-child(1) > div > div:nth-child(3) > p.disco-list-view-item-description").innerText = i18n.getLocaleName().nativeName
    } catch (error) {
        document.querySelector("#home-tab > div:nth-child(1) > div > div:nth-child(3) > p.disco-list-view-item-description").innerText = i18n.getLocaleName("en-US").nativeName
    }
}
...
document.querySelector("#home-tab > div:nth-child(1) > div > div:nth-child(3)").addEventListener("flowClick", async () => {
    ...
    Object.values(availableLocales)
        ...
        .forEach(locale => {
            ...
            const item = DiscoElements.wListViewItem(
                nativeName || '',
                displayName || ''
            )
            item.stats = stats;
            ...
            document.querySelector("#language-tab > div.disco-list-view").append(item)
        })
