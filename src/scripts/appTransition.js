...
const ANIMATION_TIMINGS = {
    ...
    launchHide: function () {
        const animationDurationScale = DiscoBoard.backendMethods.animationDurationScale.get();
        ...
        return ms * 1000;
        return ((0.3 * this.baseScale() + 0.35) * 1000 + 500) * DiscoBoard.backendMethods.animationDurationScale.get()
    }
};
