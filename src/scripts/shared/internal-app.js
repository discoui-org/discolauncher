...
import { discoColors, discoThemes } from "../DiscoProperties";
import "../flowTouch.js";
...
setAccentColor(localStorage["accentColor"] || discoColors.violet);
setTheme(localStorage["theme"] === undefined ? discoThemes.dark : Number(localStorage["theme"]));
...
export {
  appViewEvents, discoColors, discoThemes, setAccentColor, setTheme, applyOverscroll
};
