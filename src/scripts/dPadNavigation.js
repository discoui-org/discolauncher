...
setInterval(() => {
    const focusElement = document.querySelector("[disco-navigation-focus]");
...
function focusElement(el) {
    document.querySelectorAll("[disco-navigation-focus]").forEach(el => el.removeAttribute("disco-navigation-focus"));
    el.setAttribute("disco-navigation-focus", "");
}
const directionalClosest = {
    ...
    getNavElements() {
        ...
        const currentFocusedEl = document.querySelector('[disco-navigation-focus]');
        let foundGroup = null;
...
window.addEventListener('keydown', (event) => {
    const current = document.querySelector('[disco-navigation-focus]');
    if (!current) return;
    let next = document.querySelector("[disco-navigation-focus]");
...
window.addEventListener('keydown', (event) => {
    if (event.key === 'Enter' || event.key === 'RemoteOK') {
        ...
        if (current) {
            ...
            if (current.classList.contains("disco-home-tile")) {
