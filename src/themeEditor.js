...
async function uninstallThemes() {
    ...
    const iframeWindow = document.querySelector("iframe").contentWindow;
    iframeWindow.DiscoBoard.backendMethods.destroyInternalApp("disco.internal.tweaks")
...
async function preview() {
    ...
    iframeWindow.Disco.launchApp(`disco.internal.tweaks?installStyle=${currentBlobUrl}`)
}
async function run(css) {
    try {
        ...
        iframeWindow.DiscoBoard.backendMethods.refreshStyles()
        setTimeout(() => {
            iframeWindow.DiscoBoard.backendMethods.refreshStyles()
        }, 500);
        setTimeout(() => {
...
const static_selectors = [
    "#app",
    "#app div.tile-list-page div.disco-home-tile",
    "#app div.tile-list-page div.disco-home-tile div.disco-tile-menu-unpin-button",
    "#app div.tile-list-page div.disco-home-tile div.disco-tile-menu-resize-button",
    "#app div.tile-list-page div.disco-home-tile div.disco-home-inner-tile",
    "#app div.tile-list-page div.disco-home-tile div.disco-home-inner-tile img.disco-home-tile-imageicon",
    "#app div.tile-list-page div.disco-home-tile div.disco-home-inner-tile p.disco-home-tile-title",
    "#app div.tile-list-page #app-page-icon",
    "#app div.app-list-page #search-icon",
    "#app div.app-list-page input.app-list-search",
    "#app div.app-list-page div.disco-letter-tile",
    "#app div.app-list-page div.disco-letter-tile p.disco-app-tile-icon",
    "#app div.app-list-page div.disco-app-tile",
    "#app div.app-list-page div.disco-app-tile div.disco-app-tile-icon",
    "#app div.app-list-page div.disco-app-tile p.disco-app-tile-title",
    "div.disco-context-menu",
    "div.disco-context-menu > div disco-context-menu-entry",
