...
scrollers.main_home_scroller.enableGuard = () =>
    DiscoBoard.backendMethods.homeConfiguration.hasTiles()
DiscoBoard.backendMethods.homeConfiguration.syncPageAvailability()
...
scrollers.main_home_scroller.on("slideWillChange", function (e) {
    if (!DiscoBoard.backendMethods.homeConfiguration.hasTiles()) {
